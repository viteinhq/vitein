 ...
 *
 * **Personal accounts cannot trigger bulk email** (ADR 0012) —
 * returns 403 `feature.b2b_only` for every caller today. The
 * endpoint stays so a future B2B account model can flip the gate
 * on; until then, share the event link directly via the creator's
 * own channels.
 *
